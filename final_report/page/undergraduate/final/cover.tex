...
\begin{flushright}
    {\bfseries 涉密论文 $\square$ ~~ 公开论文 $\boxtimes$ \multido{}{6}{\quad}}
\end{flushright}
...
}
{
    ...
    }
    {
        ...
        \newcommand{\CoverTitle}{
            题目      &  \uline{\hfill \TitleLineOne{} \hfill} \\
                      &  \uline{\hfill \TitleLineTwo{} \hfill} \\
                      &  \uline{\hfill \TitleLineThree{} \hfill} \\
        }
    }
}
...
}
{
    ...
    \begin{center}
        ...
        \begin{tabularx}{.7\textwidth}{>{\fangsong}l >{\fangsong}X<{\centering}}
            ...
            {%   MajorLines == 1
            年级专业    &  \uline{\hfill \mbox{\Grade}级\Major \hfill} \\
            }
            {%   MajorLines == 2
            年级专业    &  \uline{\hfill \mbox{\Grade}级\MajorLineOne \hfill} \\
