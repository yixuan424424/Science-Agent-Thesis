...
\documentclass[
    ...
    ListOfFigures   = true,
    ListOfTables    = true,
    ListOfAlgorithms= true,
    % Title
    Title           = 面向科学场景的智能体工具调用优化研究,
    TitleEng        = {{Optimizing Tool Invocation of LLM Agents for Scientific Scenarios}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{面向科学场景的智能体}{工具调用优化研究}
\titleengtwolines{Optimizing Tool Invocation of LLM Agents}{for Scientific Scenarios}
...
\newcommand{\inputundergraduate}
{
    \ifthenelse{\equal{\Period}{final}}
    {
        ...
        \bodystyle
        % \inputpage{final}{cover-part}  % 答辩材料不要求
